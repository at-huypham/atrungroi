...
public class IntroTest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dotsLayout = (LinearLayout) findViewById(R.id.llDots);
    ...
    private void launchHomeScreen() {
        prefManager.setFirstTimeLauch(false);
        startActivity(new Intent(IntroTest.this, MainActivity.class));
        finish();
    }
